...
import com.sun.xml.xsom.impl.util.SchemaTreeTraverser.SchemaTreeNode;
...
public class App {
	...
	private void printElements() {
		...
		System.out.println("-----------");
		System.out
				.println("Target namespace: " + xsSchema.getTargetNamespace());
	...
	public void particle(XSParticle part) {
		...
		for (int i = 1; i < repeat; i++) { 
			...
			part.getTerm().visit(new XSTermVisitor() {
				public void elementDecl(XSElementDecl decl) {
					System.err.println("Element Decl:" + decl.getName() + MyTraverser.this.repeatCount );
				}

				public void modelGroupDecl(XSModelGroupDecl decl) {
					System.err.println("Group Decl: " + decl.getName()  + MyTraverser.this.repeatCount );
				}

				public void modelGroup(XSModelGroup group) {
					System.err.println("Model Group"  + MyTraverser.this.repeatCount );
				}

				public void wildcard(XSWildcard wc) {
					System.err.println("wc"  + MyTraverser.this.repeatCount );
